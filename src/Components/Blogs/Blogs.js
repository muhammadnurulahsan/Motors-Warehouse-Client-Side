          ...
          <div className="col-md-6 col-sm-1">
            <div className="ms-md-5 mx-4 mt-4">
              <p className="normal-text">
                ...
                scripting language that is used to build dynamic HTML pages with
                ...
                executed and run in a web browser. We can use Node.js to execute
                and run the code outside of the browser.
              </p>
              <p className="normal-text">
                <strong>Node.js is a cross-platform</strong>, open-source
                JavaScript runtime environment that enables JavaScript to be run
                on the server. Node.js enables JavaScript code to run outside of
                the browser. Node.js comes with a large number of modules and is
                mostly used in web creation. It may run on various platforms
                including, Windows, Linux, Mac OS, etc.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="col-md-6 col-sm-1">
            <div className="ms-md-5 mx-4 mt-4">
              <p className="normal-text">
                ...
                javascript for backend development by the help of nodejs. Thats
                Why It is called a runtime and it is not a programming language.
                We Should Use nodejs when we want to develope backend for a
                website or app.
              </p>
              <p className="normal-text">
      ...
      <div className="pt-5">
        ...
        <div className="col-12 d-flex my-5 justify-content-between align-items-center flex-wrap">
          ...
          <div className="col-md-6 col-sm-1">
            <div className="ms-md-5 mx-4 mt-4">
              <p className="normal-text">
                <strong>SQL</strong> stands for Structured Query Language. It's
                used for relational databases. A SQL database is a collection of
                tables that stores a specific set of structured data. The SQL
                database has long been the tried and true workhorse of the
                backend enterprise and at the heart of everything we do in this
                electronic age. SQL was created in the early 1970s at IBM as
                method of accessing IBM’s System R database system.
              </p>
              <p className="normal-text">
                ...
                model. The main types are document, key-value, wide-column, and
                graph. They provide flexible schemas and scale easily with large
          ...
          <tbody className="text-center">
            <tr>
              <td>
                <ul className="p-2">
                  <li>
                    <p className="mt-3">SQL databases Follows ACID property.</p>
                  </li>
                  <li>
          ...
          <div className="col-md-6 col-sm-1">
            <div className="ms-md-5 mx-4 mt-4">
              <p className="normal-text">
                ...
                user accessing a website data is someone who is authorized. If a
                user isnt authorized then it will be a great disaster for a
                website if he found any valuable data. jwt add extra layer to
                user authentication. so that only valid user can have the access
                to read and write data.
              </p>
              <p className="normal-text">
                <strong>how does JWT work</strong> jwt stand for json web token.
                when a user login jwt generate a token which is sent to client.
                the token is then stored in local storage or browser cookies.
                the token has 3 part. Header , payload and signature. Header
                store the algorithm which is used to decode the token. payload
                is the data that is stored in the token. Finally the signature
                which is how the server verifies the token.
              </p>
            </div>
          </div>
          <div className="col-md-6 col-sm-1">
